...
public class SftpClientProperties {
	...
	public Map<String, SftpClientProperties> getClients() {
		return clients;
	}

	public void setClients(Map<String, SftpClientProperties> clients) {
		this.clients = clients;
	}
	
	@Override
	public String toString() {
		return "SftpClientProperties [multiple=" + multiple + ", host=" + host + ", port=" + port + ", username="
				+ username + ", password=" + password + ", pool=" + pool + ", abandoned=" + abandoned + ", clients="
				+ clients + "]";
	}
    ...
    public static class Pool {
		...
		@Override
		public String toString() {
			return "Pool [maxTotal=" + maxTotal + ", maxIdle=" + maxIdle + ", minIdle=" + minIdle + ", lifo=" + lifo
					+ ", fairness=" + fairness + ", maxWaitMillis=" + maxWaitMillis + ", minEvictableIdleTimeMillis="
					+ minEvictableIdleTimeMillis + ", evictorShutdownTimeoutMillis=" + evictorShutdownTimeoutMillis
					+ ", softMinEvictableIdleTimeMillis=" + softMinEvictableIdleTimeMillis + ", numTestsPerEvictionRun="
					+ numTestsPerEvictionRun + ", testOnCreate=" + testOnCreate + ", testOnBorrow=" + testOnBorrow
					+ ", testOnReturn=" + testOnReturn + ", testWhileIdle=" + testWhileIdle
					+ ", timeBetweenEvictionRunsMillis=" + timeBetweenEvictionRunsMillis + ", blockWhenExhausted="
					+ blockWhenExhausted + ", jmxEnabled=" + jmxEnabled + ", jmxNamePrefix=" + jmxNamePrefix
    ...
    public static class Abandoned {
		...
		@Override
		public String toString() {
			return "Abandoned [removeAbandonedOnBorrow=" + removeAbandonedOnBorrow + ", removeAbandonedOnMaintenance="
					+ removeAbandonedOnMaintenance + ", removeAbandonedTimeout=" + removeAbandonedTimeout
					+ ", logAbandoned=" + logAbandoned + ", requireFullStackTrace=" + requireFullStackTrace
					+ ", useUsageTracking=" + useUsageTracking + "]";
		}
